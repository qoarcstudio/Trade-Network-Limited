...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--bg-primary)', paddingTop: '8rem', paddingBottom: '4rem' }}>
      <div className="container">
        ...
        <div className="grid-responsive-4" style={{ 
          ...
          <RevealOnScroll className="reveal-up">
            <div>
              <h4 style={{ marginBottom: '1.5rem', fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 700 }}>Product</h4>
          ...
          <RevealOnScroll className="reveal-up" delay={100}>
            <div>
              <h4 style={{ marginBottom: '1.5rem', fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 700 }}>Information</h4>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem', padding: 0 }}>
          ...
          <RevealOnScroll className="reveal-up" delay={200}>
            <div>
              <h4 style={{ marginBottom: '1.5rem', fontSize: '1rem', color: 'var(--text-primary)', fontWeight: 700 }}>Company</h4>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem', padding: 0 }}>
          ...
          <RevealOnScroll className="reveal-up" delay={300}>
            <div style={{ 
              ...
              <h4 style={{ fontSize: '1.125rem', color: 'var(--text-primary)', fontWeight: 700 }}>Subscribe</h4>
        ...
        <RevealOnScroll className="reveal-up" delay={400}>
          <div className="flex justify-between items-center flex-col-md gap-md" style={{ textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', color: '#4966af', gap: '0.75rem' }}>
              ...
              <span style={{ fontWeight: 800, fontSize: '1.5rem', color: 'var(--text-primary)', letterSpacing: '-0.03em' }}>Trade Network Limited</span>
            </div>

            {/* Legal Links Center */}
            <div style={{ display: 'flex', gap: '2.5rem', fontSize: '0.875rem', fontWeight: 600, color: 'var(--text-primary)' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href="#" style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--bg-secondary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)', border: '1px solid var(--border-light)' }}>
